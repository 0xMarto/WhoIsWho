...
public class GameCelebrity {
    ...
    private Card pickRandomCard() {
        String cards[] = {"Fox", "Depp", "Veron", "Garcia", "Wilson", "Torres", "Zlatan", "Aniston", "Stone", "Potter",
                "Beckham", "Ron", "Gandhi", "Norris", "Ryan", "Davids", "Messi", "Slash", "Jackson", "Streep", "Cruz",
                "Zidane", "Guille", "Anne"};
